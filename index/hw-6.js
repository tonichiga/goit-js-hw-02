...
////////// а расшифровка будет такой:

// function converter(userObject) {
...
// const getUsersWithGender = (array, gender) => array.filter((array) => gender === array.gender).map(({name}) => name);
...
// Write code under this line
const getSortedUniqueSkills = (array) => array.map(({ skills }) => skills).reduce((acc, skills) => [...acc, ...skills], []).filter((skills, i, array) => array.indexOf(skills) === i ).sort()
